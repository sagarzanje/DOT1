        ...
        chartAPI('multiaxisline', {
            ...
            spaceManager: function(hcJSON, fcJSON, width, height) {
                ...
                var iapi = this,
                    ...
                    xl,
                    xr,
                    marginLeftBeforeAxisCalc = hcJSON.chart.marginLeft,
                    marginRightBeforeAxisCalc = hcJSON.chart.marginRight,
                    marginLeftExtraSpace = conf.marginLeftExtraSpace,
                    marginTopExtraSpace = conf.marginTopExtraSpace,
                    marginBottomExtraSpace = conf.marginBottomExtraSpace,
                    marginRightExtraSpace = conf.marginRightExtraSpace,
                ...
                alignCaptionWithCanvas = hcJSON.title.alignWithCanvas;
                captionWidth = hcJSON.title._captionWidth;

                xc = (alignCaptionWithCanvas) ? hcJSON.chart.marginLeft + (canvasWidth / 2) : width / 2;
                xl = (alignCaptionWithCanvas) ? hcJSON.chart.marginLeft : marginLeftBeforeAxisCalc;
                xr = (alignCaptionWithCanvas) ? width - hcJSON.chart.marginRight
                                                : width - marginRightBeforeAxisCalc;


                switch (hcJSON.title.align) {
                    case POSITION_LEFT:
                        hcJSON.title.x = xl;
                        hcJSON.title.align = 'start';
                        break;
                    case POSITION_RIGHT:
                        hcJSON.title.x = xr;
                        hcJSON.title.align = 'end';
                        break;
                    default:
                        hcJSON.title.x = xc;
                        hcJSON.title.align = 'middle';
                }
